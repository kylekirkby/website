...
![Modding Arrow Audio Mezz Image 1](/assets/images/blog/modding-arrows-img-1.png){:class="img-responsive lazyload"}

# **Understanding the Modification**

![Modding Arrow Audio Mezz Image 2](/assets/images/blog/modding-arrows-img-2.png){:class="img-responsive lazyload"}
![Modding Arrow Audio Mezz Image 3](/assets/images/blog/modding-arrows-img-3.png){:class="img-responsive lazyload"}
...
![Modding Arrow Audio Mezz Image 4](/assets/images/blog/modding-arrows-img-4.png){:class="img-responsive lazyload"}
![Modding Arrow Audio Mezz Image 5](/assets/images/blog/modding-arrows-img-5.png){:class="img-responsive lazyload"}
...
1.  Carefully pry out the plastic part of the i2c header on the audio mezz, using a thin flat head screwdriver between the PCB and header to provide leverage and push out the plastic.  
    ...
    ![Modding Arrow Audio Mezz Image 6](/assets/images/blog/modding-arrows-img-6.png){:class="img-responsive lazyload"}
...
![Modding Arrow Audio Mezz Image 7](/assets/images/blog/modding-arrows-img-7.jpg){:class="img-responsive lazyload"}
